<template>
    <header
        :class="['w-full md:px-3 shadow-md bg-white transition-all', isScrolled ? 'fixed top-0 z-50 shadow-lg' : '']">
        <div class="p-4 w-full md:max-w-384 mx-auto flex justify-between items-center">
            <a href="/"><img :src="logo" alt="Logo" class="w-48 md:w-64"></a>
            <button @click="scrollToContact" class="bg-primary px-6 py-2 rounded text-white">Get Started</button>
        </div>
...
function handleScroll() {
    isScrolled.value = window.scrollY > 10; // adjust threshold
}
